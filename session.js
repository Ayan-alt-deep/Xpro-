...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "ANJU-XPRO~XcEWUSjC#klPASNer2NPOf27mJwC8BVxiANvm_jPQq5E_k37AfcU",
    GITHUB_TOKEN: process.env.GITHUB_TOKEN || "github token without ghp_",
    GITHUB_USERNAME: process.env.GITHUB_USERNAME || "itachi-prime99",
    SUDO: process.env.SUDO ? process.env.SUDO.split(",") : ["94717775628", "8801839268235"],
